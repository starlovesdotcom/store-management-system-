...
products = [
    ...
    {"name": "Whole Wheat Bread", "price": 2.99, "qty": 12, "category": "Bakery"},   {"name": "Croissants", "price": 3.49, "qty": 10, "category": "Bakery"},
...
while True:
    ...
    print("-------------------------")
    if choice== 1 :
        print("Add a new product section:")
        print("=====================================")
        print("Please fill the following questions:(type 'exit' to leave this section)")
        print("=====================================")
        ...
        if category == "exit":
            ...
            sleep(2)
            continue
        if name !="exit" or price !="exit" or quantity !="exit" or category !="exit":
